...
import { colorChanged, statusChanges } from "../redux/filters/actionCreators";


const numberOfTodos = (numberOf_todos) => {
    switch (numberOf_todos) {
        case 0:
            return 'No task';
        case 1:
            return "1 task";
        default:
            return `${numberOf_todos} tasks`;
    }
};
